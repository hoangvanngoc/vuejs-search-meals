<template>
    ...
    <div class="grid grid-cols-1 px-8 gap-4 md:grid-cols-4">
        <div v-for="meal of meals" :key="idMeal" class="p-2 bg-white shadow rounded-xl">
            ...
            <div class="flex flex-col gap-y-2">
                <a target="_blank" class="w-full px-8 text-center rounded-6 g-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded py-4" :href="meal.strYoutube">Youtube</a>
